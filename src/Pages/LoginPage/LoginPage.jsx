...
export const LoginPage = () => {
   ...
   const { message } = useAppSelector((state) => state.login.data)
   ...
   const formik = useFormik({
      ...
      validationSchema: Yup.object({
         username: Yup.string().required("You need to enter your login to continue"),
   ...
   return (
      <>
         ...
         <section className="login-section">
            <img src="/login.webp" alt="login-img" width={420} height={350} />
            <form
            ...
            {message === "Authentication successful." ? <Navigate to={"/table"} /> : null}
         </section>
      </>
   );
}
